...
echo
echo $red" Tool akan di install dalam waktu 5 detik saja"
echo $red" Sabar Anjing Gua Bacok lu asu :)"
sleep 1
echo '''\a
\033[35;1m             _____
\033[35;1m            |___ /
...
echo
echo $red" Tool akan di install dalam waktu 5 detik saja"
echo $red" Sabar Anjing Gua Santet Only lo :)"
sleep 1
echo '''\a
\033[33;1m             _  _
\033[33;1m            | || |
...
echo
echo $red" Tool akan di install dalam waktu 5 detik saja"
echo $red" Sabar Terus Anjing Gak Sabar Bisa Gak ASUU:)"
sleep 1
echo '''\a
\033[36;1m              ____
\033[36;1m             | ___|
...
echo $me"█"$bi"  Recode  :  Mr.J4rzz      "$me"      █"
echo $ku"█"$bi"  WhatsApp:  0878xxxxxxx"$ku"         █"
echo $bi"█"$bi"  Fb      :  fb.me/kangtOxiic    "$bi"█"
echo $i"█"$bi"  github   :  wwwgithub/SystemRusak"$i"█"
echo $me"==================="$ku" ==================="
echo
echo $i"-----› Menu BRUTEPORCE NEWS Anjing:"
...
echo
echo $pu"╭─["$i"Pilih sesuai ke inginan Anda Gua Jin ajg bisa ngabulkan permintaan"$pu"]"
read -p"╰─> : " pil
...
sleep 2
echo $me"Recode by : Kang-Rusak"
sleep 2
echo $ku"Facebook :"$pur" Whe Are Rizal Mechazine"
echo $ku"github   :"$pur" https://github.com/SystemRusak"
echo $ku"WhatsApp :"$pur" 0878xxxxxxx"
echo
exit
fi
